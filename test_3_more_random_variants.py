...
def test_3_more_random_variants():
    """Test URL transformation with 3 different random variants from database."""
    ...
    # Select 3 different random variants (using different seed)
    random_variants = df.sample(n=3, random_state=123)  # Different seed for different results
    
    print("Testing 3 More Random Variants from Database:")
    print("=" * 80)
    
    for i, row in random_variants.iterrows():
        variant = row['variant']
