...
def test_random_variants():
    """Test URL transformation with 3 random variants from database."""
    ...
    # Select 3 random variants
    random_variants = df.sample(n=3, random_state=42)  # Fixed seed for reproducible results
    
    print("Testing 3 Random Variants from Database:")
    print("=" * 80)
